...
description: |
  ...
  Cherry-picks only this branch's commits, dropping stale commits from the base branch.
...
This keeps only the commits belonging to this branch's ticket, dropping stale commits from the now-merged base branch.
...
1. **Fetch and identify commits:**
   ...
   Identify which commits belong to this branch's ticket.
